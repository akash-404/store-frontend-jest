...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                err_3 = _a.sent();
                res.status(400).json("Problem in create user route. -------- ".concat(err_3));
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
}); };
var authorise = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.authorise(user.username, user.password)];
            case 2:
                u = _a.sent();
            ...
            case 3:
                err_4 = _a.sent();
                res.status(401).json("Problem in authorise user route. -------- ".concat(err_4));
                return [3 /*break*/, 4];
            case 4: return [2 /*return*/];
        }
    });
...
var userRoutes = function (app) {
    app.get('/users', authenticator_1.authenticate, index);
    app.get('/users/:id', authenticator_1.authenticate, show);
    app.post('/users', create);
    app.post('/users/authenticate', authorise);
    app.delete('/users/:id', authenticator_1.authenticate, delete1);
};
