...
var showByCategory = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.showByCategory(req.body.category)];
            case 1:
                product = _a.sent();
                res.json(product);
                return [3 /*break*/, 3];
...
var productRoutes = function (app) {
    ...
    app.post('/products', authenticator_1.authenticate, create);
    app.delete('/products/:id', authenticator_1.authenticate, delete1);
};
