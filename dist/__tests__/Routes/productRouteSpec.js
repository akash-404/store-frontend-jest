    ...
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    throw new Error("Unable to run endpoint test --------".concat(err_1));
    ...
    it("should create new product", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, request.post('/products').send(product).set('Authorization', token)];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    err_2 = _a.sent();
                    throw new Error("Unable to run create test --------".concat(err_2));
                case 3: return [2 /*return*/];
            }
        });
    }); });
    it("should get product info", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_3 = _a.sent();
                    throw new Error("Unable to run create test --------".concat(err_3));
                case 3: return [2 /*return*/];
            }
        });
    }); });
    ...
    it("should delete product", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, request.delete('/products/1').set('Authorization', token)];
                case 1:
                    response = _a.sent();
                    expect(response.status).toBe(200);
                    return [3 /*break*/, 3];
