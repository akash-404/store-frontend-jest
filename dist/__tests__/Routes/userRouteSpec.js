    ...
    it("should create new user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_1 = _a.sent();
                    throw new Error("Unable to test create new user. --------".concat(err_1));
    ...
    it("should get list of users", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_2 = _a.sent();
                    throw new Error("Unable to run index test --------".concat(err_2));
                case 3: return [2 /*return*/];
            }
        });
    }); });
    it("should get user info", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_3 = _a.sent();
                    throw new Error("Unable to run show test --------".concat(err_3));
                case 3: return [2 /*return*/];
            }
        });
    }); });
    it("should delete user", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    err_4 = _a.sent();
                    throw new Error("Unable to run delete test --------".concat(err_4));
                case 3: return [2 /*return*/];
            }
        });
    }); });
